...
- scripts 8
  ...
  ```yaml
  { 
    {1,{{2,122,0-0:44.1.0.255,1,{{"\LPCAP_1",1},{"\LPCAP_2",1},...}}}}, 
    //enable LP1+2
    {2,{{2,122,0-0:44.1.0.255,1,{{"\LPCAP_1",0},{"\LPCAP_2",0},...}}}}, 
    //disable LP1+2
    {3,{{2,122,0-0:44.1.0.255,1,{{"\LPCAP_1",1},...}}}}, //enable LP1
    {4,{{2,122,0-0:44.1.0.255,1,{{"\LPCAP_1",0},...}}}}, //disable LP1
    {5,{{2,122,0-0:44.1.0.255,1,{{"\LPCAP_2",1},...}}}}, //enable LP2 
    {6,{{2,122,0-0:44.1.0.255,1,{{"\LPCAP_2",0},...}}}}, //disable LP2
    {7,{{2,122,0-0:44.1.0.255,1,{{"\IF_LO_2W",1},...}}}}, //enable 2 way coms on local interface
    {8,{{2,122,0-0:44.1.0.255,1,{{"\IF_LO_2W",0},...}}}} //disable 2 way coms on local interface
  }
  ```

- push_protection_parameters 14
